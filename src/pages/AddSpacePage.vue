    ...
    <a-card title="空间级别介绍">
      <a-typography-paragraph>
        * 目前仅支持开通普通版，如需升级空间，请联系
        <a href="https://github.com/wangjinchanye" target="_blank">作者</a>
      </a-typography-paragraph>
...
import { SPACE_LEVEL_OPTIONS, SPACE_LEVEL_ENUM, SPACE_TYPE_MAP, SPACE_TYPE_ENUM } from '@/constants/space'
