...
export async function getUserByIdUsingPost(body: number, options?: { [key: string]: any }) {
...
/** listUserVOByPage POST /api/user/page/list/vo */
export async function listUserVoByPageUsingPost(
  body: API.UserQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageUserVO_>('/api/user/page/list/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
